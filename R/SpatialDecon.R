...
#'     cluster_markers = clustermarkers_list[[cluster]][1:25]
#'     cluster_score <- apply(
#'       TumorST@assays$Spatial@data[rownames(TumorST@assays$Spatial@data) %in% cluster_markers,],
#'       2,mean)
#'     meta_data <- cbind(meta_data,cluster_score)
#'   }
#'   colnames(meta_data) <- c("nCount_Spatial","Decon_topics","Location",names(clustermarkers_list))
...
#'   DeconData <- SpatialDecon(enrich_matrix, enrich_result,
#'                             filter_expr, filter_sig,
#'                             clustermarkers_list, meta_data,
#'                             malignant_cluster, tissue_cluster,
#'                             stromal_cluster)
#' }
#'

SpatialDecon <- function(enrich_matrix,
                         enrich_result,
                         filter_expr,
                         filter_sig,
                         clustermarkers_list,
