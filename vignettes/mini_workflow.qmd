...
title: "mini workflow"
vignette: >
  %\VignetteIndexEntry{mini workflow}
...
```{r}
#| eval: false
TumorST <- readr::read_rds('path_to/CRC1/CRC1_BoundaryDefine.rds.gz')
...
```{r}
#| eval: false
DiffGenes <- readr::read_rds('path_to/CRC1/1.SpatialDiffGenes.rds')
